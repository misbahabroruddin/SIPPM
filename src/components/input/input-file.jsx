...
export const InputFile = ({
  ...
  return (
    <label
      htmlFor={name}
      className={twMerge(
        "flex justify-center items-center border border-gray-100 p-6 rounded-lg cursor-pointer relative",
    ...
    >
      <div className='flex flex-col gap-2 items-center'>
        ...
        <label htmlFor={name} className='cursor-pointer text-center'>
          ...
          {errors && (
            <p className='text-red-500 text-center mt-2'>{errors.message}</p>
          )}
        </label>
      </div>
      <input
