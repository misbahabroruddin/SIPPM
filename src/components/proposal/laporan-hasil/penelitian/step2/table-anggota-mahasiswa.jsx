...
import { ModalDetailAnggotaMahasiswaLaporanHasil } from "./modal-detail-anggota-mahasiswa";
import { useDeleteAnggotaProposal } from "@/handlers/dosen/proposal/anggota/delete-anggota";

export const TableAnggotaMahasiswaLaporanHasil = ({ data }) => {
            ...
            return (
              <tr key={row.id} className="text-base even:bg-sky">
                ...
                <td className="mx-auto py-2 text-center lg:py-3">
                  <ModalDetailAnggotaMahasiswaLaporanHasil id={row.id} />
                  <button
