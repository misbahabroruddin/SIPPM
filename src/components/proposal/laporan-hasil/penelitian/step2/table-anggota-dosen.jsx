...
import { ModalDetailAnggotaDosenLaporanHasil } from "./modal-detail-anggota-dosen";
import { useDeleteAnggotaProposal } from "@/handlers/dosen/proposal/anggota/delete-anggota";

export const TableAnggotaDosenLaporanHasil = ({ data }) => {
            ...
            return (
              <tr key={row.id} className="text-base even:bg-sky">
                ...
                <td className="mx-auto py-2 text-center lg:py-3">
                  <ModalDetailAnggotaDosenLaporanHasil id={row.id} />
                  <button
