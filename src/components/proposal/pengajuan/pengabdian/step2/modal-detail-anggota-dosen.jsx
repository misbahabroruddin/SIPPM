...
import { useQueryDetailAnggotaDosenPKM } from "@/handlers/dosen/pengabdian/anggota/query-detaill-anggota-dosen-pkm";
...
export const ModalDetailAnggotaDosen = ({ id }) => {
  ...
  const { data: detail } = useQueryDetailAnggotaDosenPKM(id);
