...
import { useAdministratorCreateAnggotaMahasiswa } from "@/handlers/anggota/administrator/create-anggota-mahasiswa";

export const FormTambahMahasiswa = ({ setOpen }) => {
  const id = useId();
  ...
  const { mutateAsync, isPending } =
    useAdministratorCreateAnggotaMahasiswa(reset);

  const onCreateAnggotaMahasiswa = async (data) => {
    try {
