...
import { useQueryDetailAnggotaDosenLaporanHasilPenelitian } from "@/handlers/dosen/laporan-hasil/penelitian/anggota/query-detail-anggota-dosen";

export const ModalDetailAnggotaDosen = ({ id }) => {
  const [openModal, setOpenModal] = useState(false);
  const { detail } = useQueryDetailAnggotaDosenLaporanHasilPenelitian(id);
