...
import { useQueryDetailAnggotaMahasiswaPenelitian } from "@/handlers/dosen/penelitian/anggota/query-detail-anggota-mahasiswa";
import { useQueryDetailAnggotaMahasiswaLaporanHasilPenelitian } from "@/handlers/dosen/laporan-hasil/penelitian/anggota/query-detail-anggota-mahasiswa";

export const ModalDetailAnggotaMahasiswa = ({ id }) => {
  const [openModal, setOpenModal] = useState(false);
  const { detail } = useQueryDetailAnggotaMahasiswaLaporanHasilPenelitian(id);
