...
import { useDeleteRincianKegiatanLaporanHasilPenelitian } from "@/handlers/dosen/laporan-hasil/penelitian/rincian-kegiatan/delete-rincian-kegiatan";

export const TableRincianKegiatan = ({ data }) => {
  const { deleteRincianKegiatanPenelitian, isLoadingDelete } =
    useDeleteRincianKegiatanLaporanHasilPenelitian();
