...
import { useQueryDetailRincianKegiatanLaporanHasilPenelitian } from "@/handlers/dosen/laporan-hasil/penelitian/rincian-kegiatan/query-detail-rincian-kegiatan";
import { useAddEditRincianKegiatanLaporanHasilPenelitian } from "@/handlers/dosen/laporan-hasil/penelitian/rincian-kegiatan/add-edit-rincian-kegiatan";
...
export const FormRincianKegiatan = ({ onClose, id }) => {
  ...
  const { detailRincianKegiatanPenelitian } =
    useQueryDetailRincianKegiatanLaporanHasilPenelitian(
      id,
      setStartDate,
      setEndDate,
      setValue,
  ...
  const { onSubmitRincianKegiatanPenelitian, isLoadingSubmit } =
    useAddEditRincianKegiatanLaporanHasilPenelitian(
      id,
      setStartDate,
      setEndDate,
      reset,
