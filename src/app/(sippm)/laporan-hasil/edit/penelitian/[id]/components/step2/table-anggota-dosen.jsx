...
import { useDeleteAnggotaLaporanHasilPenelitian } from "@/handlers/dosen/laporan-hasil/penelitian/anggota/delete-anggota-penelitian";

export const TableAnggotaDosen = ({ data }) => {
  const { onDeleteAnggotaDosenPenelitian, isLoadingDosen } =
    useDeleteAnggotaLaporanHasilPenelitian();
