...
import { ModalEditRencanaAnggaran } from "./modal-edit-rencana-anggaran-pkm";
import { useDeleteRencanaAnggaranLaporanHasilPKM } from "@/handlers/dosen/laporan-hasil/pengabdian/rencana-anggaran/delete-rencana-anggaran-pkm";

export const TableRencanaAnggaran = ({ data }) => {
  const header = ["No", "Rincian", "Biaya", "Action"];

  const { deleteRencanaAnggaranPKM, isPending } =
    useDeleteRencanaAnggaranLaporanHasilPKM();
