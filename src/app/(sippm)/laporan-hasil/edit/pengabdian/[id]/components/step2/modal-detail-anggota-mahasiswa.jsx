...
import { useQueryDetailAnggotaMahasiswaLaporanHasilPKM } from "@/handlers/dosen/laporan-hasil/pengabdian/anggota/query-detail-anggota-mahasiswa-pkm";
...
export const ModalDetailAnggotaMahasiswa = ({ id }) => {
  ...
  const { data: detail } = useQueryDetailAnggotaMahasiswaLaporanHasilPKM(id);
