...
import { useQueryDetailRincianKegiatanLaporanHasilPKM } from "@/handlers/dosen/laporan-hasil/pengabdian/rincian-kegiatan/query-detail-rincian-kegiatan-pkm";
import { useAddEditRincianKegiatanLaporanHasilPKM } from "@/handlers/dosen/laporan-hasil/pengabdian/rincian-kegiatan/add-edit-rincian-kegiatan-pkm";
...
export const FormRincianKegiatanPKM = ({ onClose, id }) => {
  ...
  const { data } = useQueryDetailRincianKegiatanLaporanHasilPKM(
    setValue,
    setStartDate,
    setEndDate,
    id,
