...
import { useQueryDetailAnggotaDosenLaporanHasilPKM } from "@/handlers/dosen/laporan-hasil/pengabdian/anggota/query-detail-anggota-dosen-pkm";
...
export const ModalDetailAnggotaDosen = ({ id }) => {
  ...
  const { data: detail } = useQueryDetailAnggotaDosenLaporanHasilPKM(id);
