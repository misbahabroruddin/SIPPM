...
import { useDeleteAnggotaLaporanHasilPKM } from "@/handlers/dosen/laporan-hasil/pengabdian/anggota/delete-anggota-pkm";
...
export const TableAnggotaDosenPKM = ({ data }) => {
  ...
  const { onDeleteAnggotaDosenPKM, isLoadingDosenPKM } =
    useDeleteAnggotaLaporanHasilPKM();
