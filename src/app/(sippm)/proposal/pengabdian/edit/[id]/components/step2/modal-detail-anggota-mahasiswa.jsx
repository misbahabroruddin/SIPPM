...
import { useQueryDetailAnggotaMahasiswaPKM } from "@/handlers/pengabdian/anggota/query-detail-anggota-mahasiswa";

export const ModalDetailAnggotaMahasiswa = ({ id }) => {
  const [openModal, setOpenModal] = useState(false);
  const { detail } = useQueryDetailAnggotaMahasiswaPKM(id);
