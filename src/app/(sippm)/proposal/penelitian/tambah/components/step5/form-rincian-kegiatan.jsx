...
import { useQueryDetailRincianKegiatanPenelitian } from "@/handlers/penelitian/rincian-kegiatan/query-detail-rincian-kegiatan-penelitian";
import { useAddEditRincianKegiatanPenelitian } from "@/handlers/penelitian/rincian-kegiatan/add-edit-rincian-kegiatan-penelitian";
        ...
        <Controller
          ...
          render={({ field: { onChange } }) => (
            <ReactDatePicker
              ...
              className='ml-12 focus:outline-none !p-0'
              isClearable
