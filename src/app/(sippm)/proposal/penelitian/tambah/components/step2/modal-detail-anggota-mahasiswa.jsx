...
import { useQueryDetailAnggotaMahasiswaPenelitian } from "@/handlers/penelitian/anggota/query-detail-anggota-mahasiswa";

export const ModalDetailAnggotaMahasiswa = ({ id }) => {
  const [openModal, setOpenModal] = useState(false);
  const { detail } = useQueryDetailAnggotaMahasiswaPenelitian(id);
    ...
    <>
      ...
      >
        <div className='flex flex-col justify-start gap-4'>
          <h2 className='text-primary font-semibold'>Detail Mahasiswa</h2>
          <button
