...
import { useResetPenelitian } from "@/handlers/admin-sippm/proposal/reset-penelitian";
import { Spinner } from "@material-tailwind/react";

export const ListPenelitianAdministrator = ({
  penelitian,
  isLoading,
  handlePageChange,
  refetch,
...
const ListItem = ({ data, refetch }) => {
  const { mutateAsync: onResetPenelitian, isPending: isLoading } =
    useResetPenelitian();

  const handleReset = async () => {
    await onResetPenelitian(data?.id);
    refetch();
  };
  return (
