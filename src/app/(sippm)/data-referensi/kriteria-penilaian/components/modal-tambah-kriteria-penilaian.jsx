...
import { FormTambahKriteriaPenilaian } from "./form-tambah-kriteria-penilaian";

export const ModalTambahKriteriaPenilaian = () => {
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <FormTambahKriteriaPenilaian setOpen={setOpen} />
        </div>
      </Modal>
    </>
  );
