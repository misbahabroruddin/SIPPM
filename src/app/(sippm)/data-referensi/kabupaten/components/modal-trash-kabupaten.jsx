...
import { TableTrashKabupaten } from "./table-trash-kabupaten";

export const ModalTrashKabupaten = () => {
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-4">
          <h1 className="text-center text-lg font-[500]">Trash Kabupaten</h1>
          <TableTrashKabupaten onClose={() => setOpen(false)} />
        </div>
      </Modal>
    </>
  );
