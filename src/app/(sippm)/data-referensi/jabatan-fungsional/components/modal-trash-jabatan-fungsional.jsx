...
import { TableTrashJabatanFungsional } from "./table-trash-jabatan-fungsional";

export const ModalTrashJabatanFungsional = () => {
      ...
      >
        <div className="flex flex-col gap-4">
          <h1 className="text-center text-lg font-[500]">
            Trash Jabatan Fungsional
          </h1>
          <TableTrashJabatanFungsional onClose={() => setOpen(false)} />
        </div>
      </Modal>
    </>
  );
