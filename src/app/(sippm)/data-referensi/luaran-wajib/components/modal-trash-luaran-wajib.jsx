...
import { TableTrashLuaranWajib } from "./table-trash-luaran-wajib";

export const ModalTrashLuaranWajib = () => {
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-4">
          <h1 className="text-center text-lg font-[500]">Trash Luaran Wajib</h1>
          <TableTrashLuaranWajib onClose={() => setOpen(false)} />
        </div>
      </Modal>
    </>
  );
