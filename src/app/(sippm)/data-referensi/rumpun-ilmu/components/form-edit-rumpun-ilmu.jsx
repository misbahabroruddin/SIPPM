...
import { useQueryEditRumpunIlmu } from "@/handlers/data-referensi/rumpun-ilmu/administrator/edit-rumpun-ilmu";

export const FormEditRumpunIlmu = ({ id, setOpen, data, isLoading }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const { mutateAsync, isPending } = useQueryEditRumpunIlmu(id);
